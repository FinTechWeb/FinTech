  ...
  return (
    <div className="pf-root">
      ...
      <aside className={`pf-sidebar${sidebarOpen ? " pf-sidebar--open" : ""}`}>
        <div className="pf-logo">Logo</div>
        <nav className="pf-nav">
          {NAV_ITEMS.map(({ id, label, icon: Icon }) => (
            <button
              key={id}
              onClick={() => { onNavigate?.(id); setSidebarOpen(false); }}
              className={`pf-nav-item${id === active ? " pf-nav-item--active" : ""}`}
            >
              <Icon size={20} color={id === active ? "#fff" : "#888"} />
      ...
      <div className="pf-main">
        ...
        <header className="pf-topbar">
          ...
          <div className="pf-topbar__spacer" />
          <div className="pf-user-area">
            <div className="pf-topbar-avatar-wrap">
              <img
                src={AVATAR_SRC}
                alt="Kabir Akinola"
                className="pf-topbar-avatar-img"
              />
            </div>
            <span className="pf-username">Kabir Akinola</span>
            <svg className="pf-chevron" width={14} height={14} viewBox="0 0 24 24" fill="none">
        ...
        {/* ── Mobile page header: name centered ── */}
        <div className="pf-mobile-header">
          ...
          <span className="pf-mobile-name">Kabir Akinola</span>
        </div>
        ...
        <div className="pf-content">
          <div className="pf-card">
            ...
            <div className="pf-profile-header pf-desktop-only">
              <div className="pf-profile-header__left">
                <div className="pf-big-avatar" />
                <span className="pf-name">Kabir Akinola</span>
              </div>
              <button className="pf-edit-btn pf-edit-btn--filled">Edit profile</button>
            </div>

            <hr className="pf-divider pf-desktop-only" />

            {/* ── Personal details ── */}
            <div className="pf-section-header">
              <p className="pf-section-title">Personal details</p>
              <button className="pf-edit-btn pf-edit-btn--outline pf-mobile-only">Edit</button>
            </div>
            ...
            {/* ── Transaction limits ── */}
            <div className="pf-section-header">
              <p className="pf-section-title">Transaction limits</p>
              <button
                className="pf-edit-btn pf-edit-btn--outline pf-mobile-only"
...
/* ══════════ ICONS ══════════ */
function HomeIcon({ size = 20, color = "#888" }) {
  return (
...
function HistoryIcon({ size = 20, color = "#888" }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
function BeneficiariesIcon({ size = 20, color = "#888" }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
function ShieldIcon({ size = 20, color = "#888" }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
function PersonIcon({ size = 20, color = "#888" }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
